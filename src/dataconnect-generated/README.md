...
```typescript
getSkills(vars?: GetSkillsVariables): QueryPromise<GetSkillsData, GetSkillsVariables>;
...
```typescript
getSkills(dc: DataConnect, vars?: GetSkillsVariables): QueryPromise<GetSkillsData, GetSkillsVariables>;
